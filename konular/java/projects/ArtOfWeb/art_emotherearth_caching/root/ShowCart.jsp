<%@ page import="java.util.*, com.nealford.art.caching.emotherearth.entity.Product, com.nealford.art.caching.emotherearth.entity.CartItem" %>
<html>
<head>
<title>
ShowCart
...
<jsp:useBean id="cart" scope="session"
        class="com.nealford.art.caching.emotherearth.util.ShoppingCart" />
<body>
<h1>
