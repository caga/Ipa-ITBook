<%@ page import="java.util.*, com.nealford.art.cachingpool.emotherearth.entity.Product, com.nealford.art.cachingpool.emotherearth.entity.CartItem" %>
<html>
<head>
<title>
ShowCart
...
<jsp:useBean id="cart" scope="session"
        class="com.nealford.art.cachingpool.emotherearth.util.ShoppingCart" />
<body>
<h1>
