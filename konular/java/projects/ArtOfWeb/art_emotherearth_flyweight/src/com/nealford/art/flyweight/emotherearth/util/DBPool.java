package com.nealford.art.flyweight.emotherearth.util;
/**
...
public class DBPool {
     ...
     * @param username Connection userName (for all connections)
     * @param password Connection password (for all connections)
     *
     * @throws SQLException
     */
    public DBPool(String classname, String url, String username,
        ...
        if (username == null) System.err.println("ERROR: Null JDBC username");
        else connectionProperties.setProperty("user",username);
        if (password == null) System.err.println("ERROR: Null JDBC password");
    ...
    private java.sql.Connection openNewConnection()
        ...
        try { // Open a new connection and return that.
            ...
            System.err.println("DBPool.openNewConnection: Failed: "+e);
            throw e;
        }
    }
